...
with tab_individual:
    ...
    with col1:
        st.metric("Cantidad actual en sistema", f"{row['stock']} {row['unidad']}")
    with col2:
...
with tab_masivo:
    ...
    edited = st.data_editor(
        ...
        column_config={
            ...
            "stock_sistema": st.column_config.NumberColumn("Cantidad Sistema", disabled=True),
            "stock_real": st.column_config.NumberColumn("Cantidad Real ✏️", min_value=0.0, step=0.5),
        },
